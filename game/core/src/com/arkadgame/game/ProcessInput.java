...
public class ProcessInput extends InputAdapter {
    ...
    public boolean keyDown(int button) {
        ...
        if (button == Input.Keys.S) {
            S = true;
        }
        if (button == Input.Keys.A) {
            A = true;
        }
        if (button == Input.Keys.D) {
            D = true;
        }
        if (button == Input.Keys.P) {
            P = true;
        }
        ...
        if (button == Input.Keys.SHIFT_LEFT) {
            Shift = true;
        }
        if (button == Input.Keys.CONTROL_LEFT) {
            Ctrl = true;
        }
        return true;
    }
